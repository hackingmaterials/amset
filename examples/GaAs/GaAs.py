...
if __name__ == "__main__":
    ...
    if use_single_parabolic_band:
        ...
        model_params["poly_bands"] = [
            [[[0.0, 0.0, 0.0], [0.0, effective_mass]]]]
    ...
    # the fort.123 file contains the coefficients of the interpolated band
    # structure; it is generated by a modified version of BoltzTraP
    coeff_file = os.path.join(GaAs_path, "fort.123")

    amset = Amset.from_vasprun(
        os.path.join(GaAs_path, "vasprun.xml"),
