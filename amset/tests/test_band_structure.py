...
from amset.utils.band_structure import get_band_orbital_contributions
...
class BandStructureTest(unittest.TestCase):
    ...
    def test_get_band_orbital_contributions(self):
        s_orbital, p_orbital = get_band_orbital_contributions(self.bs, 0)
        ...
        s_orbital, p_orbital = get_band_orbital_contributions(self.bs, 10)
